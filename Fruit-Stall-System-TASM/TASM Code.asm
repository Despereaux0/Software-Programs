...
.data
  ...
  db "Mangos    ",  "Beries    ", "Cucumber  ", "Eggplant  ", "Grapes    ", "Durian    ", "Figs      ", "Plum      ", "Dates     ", "Lychee    "
  ...
  ; main menu
  menu db 13, '-----<MINI FRUITS AND VEGETABLES STALL>-----',13,10, '------------------MAIN MENU-----------------', 13, 10, 10 ,'1. View Inventory',13,10,'2. Restock Item',13,10,'3. Sell Items',13,10, '4. Sort Items',13,10,'5. Sales Report',13,10,'0. Exit the Program',13,10,'$'
  invalid_input db 13,10,'Invalid input. Please try again.',13,10,'$'
  
  ; CRUD labels
  ; view inventory
  inventory_header db 13,10, '-----<MINI FRUITS AND VEGETABLES STALL>-----',13,10, '----------------<INVENTORY>-----------------',13,10,'ID',9,'Name',9,9, 'Quantity',9, 'Price',13,10,'$'
  ...
  ;sales made
  sales_header db 13,10, '------------------<MINI FRUITS AND VEGETABLES STALL>---------------',13,10, '----------------------------<SALES REPORT>-------------------------',13,10,'ID',9,'Name',9,9, 'Quantity Sold',9, 'Price/unit', 9, 'Total Earned',13,10,'$'
